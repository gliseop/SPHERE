...
Подход SPHERE адаптирует модель Park et al. к специфике симуляции: вместо обработки реальных интервью система генерирует синтетические через управляемую цепочку, при которой каждый этап вносит вариативность, а итоговое интервью становится основным хранилищем «личности» агента.
