# Архитектурный дизайн усиленной среды SPHERE

## Цель документа

Документ развивает план усиления среды и фиксирует целевую архитектуру усиленной среды для SPHERE.
...
- устранение последних legacy `501` в web AI routes: интервью личности и secondary-agent generation теперь работают поверх текущего `sphere_lc`-контура.
...
Целевая среда SPHERE должна обладать следующими свойствами:
...
Для следующего качественного скачка SPHERE нужно усиливать не столько психологию отдельных агентов, сколько самостоятельность мира, в котором они действуют.
...
Именно такая среда делает governance-эксперименты в SPHERE существенно более жёсткими, правдоподобными и исследовательски ценными.
