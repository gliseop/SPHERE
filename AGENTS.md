...
[docs/concept.md](docs/concept.md) — концепция исследования простым языком и без привязки к платформе: проблема контроля, три элемента гибридной системы (ИИ-аудитор, репутация, коллегия), границы применимости, требования к модели для проверки, четыре режима эксперимента, гипотезы, возможные исходы и три уровня оценки.
...
│   ├── concept.md              # Концепция гибридной системы управления и её проверки (простым языком, без привязки к платформе)
