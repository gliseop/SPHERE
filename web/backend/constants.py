...
GOVERNANCE_LABELS: dict[str, str] = {
    ...
    "G2": "Аудитор (freeze роста репутации)",
    "G3": "Аудитор + коллегиальное review",
}

GOVERNANCE_DESCRIPTIONS: dict[str, str] = {
    "G0": "Нет надзора со стороны аудитора или трибунала.",
    "G1": "Аудитор может выявлять сигналы и открывать кейсы, но без freeze и без коллегиального review.",
    "G2": "Аудитор может замораживать рост репутации, но без коллегиального review.",
    "G3": "Аудитор может замораживать рост репутации и инициировать коллегиальное review.",
}
